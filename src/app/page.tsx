  ...
  return (
    <main className="min-h-screan flex flex-col items-center justify-center bg-slate-900 text-white p-4">
      <div className="text-center space-y-6 max-w-2xl">
        ...
        <Link
          href="/auth/login"
          className="px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-full font-bold transition-all transform hover:scale-105"
        >
          로그인
        </Link>
        <Link
          href="/auth/signup"
          className="px-8 py-3 bg-slate-700 hover:bg-slate-600 rounded-full font-bold transition-all"
        >
          회원가입
        </Link>
      </div>
