        ...
        <div className="max-w-2xl mx-auto p-6 space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid gap-4">
                {quests.map((q: any) => {
                    ...
                    return (
                        <div key={q.id} className={`group relative bg-slate-900 border-2 rounded-[2rem] p-6 transition-all ${canClaim ? 'border-emerald-500/50 shadow-[0_0_20px_rgba(16,185,129,0.1)]' : 'border-slate-800'}`}>
